...
export const MisplacedRow: React.FC<RowProps> = ({ onUpdate }) => {
  ...
  const classes: string =
    "font-bold xxshort:w-9 xxshort:h-9 short:text-xl short:w-10 short:h-10 w-12 h-12 border-solid border-2 flex items-center justify-center mx-0.5 text-xl font-bold rounded dark:text-white text-center uppercase rounded box-border border-yellow-500 focus:border-yellow-700 focus:caret-yellow focus:ring-yellow";
  ...
  return (
    <>
      <h3 className="mt-4 text-[16px] font-semibold">🟨 Misplaced Letters</h3>
      <p className="text-sm">
