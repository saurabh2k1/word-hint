    ...
    <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="/" className="flex items-center">
                <img src={require("../../images/wh.png")} className="mr-3 h-6 sm:h-9" alt="Word Hint Logo" />
                <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Word-Hint</span>
                <span className="text-sm px-1">Ver 1.0</span>
            </a>
